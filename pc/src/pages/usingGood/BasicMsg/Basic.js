                ...
                <Form>
                  ...
                  <FormItem>
                    <div style={{ float: 'left', marginLeft: 8, marginBottom: -30 }}>
                      ...
                      <Checkbox style={{ marginLeft: 5 }} defaultChecked onChange={(e) => { if (e.target.checked) { store.alert = 1 } else { store.alert = 2 } }} >启用库存警示功能</Checkbox>
                    </div>
...
const BasicPage = Form.create()(BasicType)
