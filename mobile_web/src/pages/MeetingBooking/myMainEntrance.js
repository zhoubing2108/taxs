  ...
  render() {
    ...
    const HistoryList = () => (
      dataSource.map(e => (<div key={e.flow.id} style={{ fontSize: 16, padding: '10px', background: '#eefaff', border: '1px solid #bbe1f1' }}>
        ...
        <span style={{ marginRight: '10px', padding: '5px 0', }}>{e.flow.place}</span>
        <span style={{ marginRight: '10px', padding: '5px 0', }}>{e.flow.purpose}</span><br />

        <span style={{ marginRight: '10px', padding: '5px 0', }}>{e.flow.time_begin}至</span>
        <span style={{ marginRight: '10px', padding: '5px 0', }}>{e.flow.time_end}</span><br />

        <span style={{ marginRight: '10px', padding: '5px 0', }}>{e.flow.reason}</span><br />
